...
const mockStore = [
    ...
    //important: maintain each account in all blocks (otherwise cannot find available id/ must check all blocks) but do NOT display if closingBalance & openingBalance & transfer (etc.) is 0
