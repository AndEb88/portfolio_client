        ...
        [ 
            {
                ...
                entries: [
                    {id: 2001, group: 'P2P', title: 'Robocash', lastUpdate: '2023-04-20', frozen: false, overallROI: 13.1, ROI: 13.3, closingBalance: 25000.00, withheldTaxes: 1, bonus: 2, transfers: 3, openingBalance: 4, grossProfit: 5, dueTaxes: 6, netProfit: 7},
                    {id: 2002, group: 'P2P', title: 'Peerberry', lastUpdate: '2023-04-30', frozen: false, overallROI: 12.4, ROI: 12.3, closingBalance: 10000.00, withheldTaxes: 0, bonus: 0, transfers: 0, openingBalance: 0, grossProfit: 0, dueTaxes: 0, netProfit: 0},
                    {id: 2003, group: 'Stock Market', title: 'Scalable Capital', lastUpdate: '2023-04-30', frozen: false, overallROI: 6.1, ROI: 12.3, closingBalance: 81000.00, withheldTaxes: 0, bonus: 0, transfers: 0, openingBalance: 0, grossProfit: 0, dueTaxes: 0, netProfit: 0},
                    {id: 2004, group: 'Other', title: 'Riester I', lastUpdate: '2023-04-30', frozen: false, overallROI: 4.1, ROI: 12.3, closingBalance: 8000.00, withheldTaxes: 0, bonus: 0, transfers: 0, openingBalance: 0, grossProfit: 0, dueTaxes: 0, netProfit: 0},
                ]
            },
            {
                block: '2022', 
                ...
                entries: [               
                    {id: 2001, group: 'P2P', title: 'Robocash', lastUpdate: '2022-04-30', frozen: true, overallROI: 13.2, ROI: 13.1, closingBalance: 23000.00, withheldTaxes: 0, bonus: 0, transfers: 0, openingBalance: 0, grossProfit: 0, dueTaxes: 0, netProfit: 0},
                    {id: 2002, group: 'P2P', title: 'Peerberry', lastUpdate: '2022-04-30', frozen: true, overallROI: 12.5, ROI: 12.5, closingBalance: 9000.00, withheldTaxes: 0, bonus: 0, transfers: 0, openingBalance: 0, grossProfit: 0, dueTaxes: 0, netProfit: 6},
                    {id: 2003, group: 'Stock Market', title: 'Scalable Capital', lastUpdate: '2022-04-30', frozen: true, overallROI: 5.1, ROI: 12.1, closingBalance: 82000.00, withheldTaxes: 0, bonus: 0, transfers: 0, openingBalance: 0, grossProfit: 0, dueTaxes: 0, netProfit: 0},
                    {id: 2004, group: 'Other', title: 'Riester I', lastUpdate: '2022-04-30', frozen: true, overallROI: 4.3, ROI: 12.2, closingBalance: 7000.00, withheldTaxes: 0, bonus: 0, transfers: 0, openingBalance: 0, grossProfit: 0, dueTaxes: 0, netProfit: 0},
                ]
            }
        ],
        ...
        [ //pension
            {
                ...
                entries: [
                    ...
                    {id: 5001, group: 'Pension', title: 'Statuatory', frozen: false, amount: 3700, expected: 6800, ROI: 3}
                    ]
            },
            {
                block: '2022',
                ...
                entries: [
                    ...
                    {id: 5001, group: 'Pension', title: 'Statuatory', frozen: true, amount: 3700, expected: 6800, ROI: 3}
                    ]
            }
        ]
    ],
