        ...
        items: [
            ...
            }, 
            {
                ...
                editForm: [
                    ...
                    {name: 'difference', title: 'Difference', operator: '=', type: 'displayNumber', unit: '€', margin: true, accent: true},
            ...
            }, 
            {
                ...
                editForm: [
                    ...
                    {name: 'openingBalance', title: 'Opening Balance', operator: '-', type: 'displayNumber', unit: '€'},
                    {name: 'grossProfit', title: 'Gross Profit', operator: '=', type: 'displayNumber', unit: '€', accent: true},
                    ...
                    {name: 'netProfit', title: 'Net Profit', operator: '=', type: 'displayNumber', unit: '€', margin: true, accent: true},
                ],
                createForm: [
                    {name: 'group', title: 'Group', operator: '', type: 'group', unit: '', bold: true},
                    {name: 'title', title: 'Title', operator: '', type: 'text', unit: '', margin: true, bold: true},
